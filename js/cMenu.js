...
class Menu {
	...
	filterParentPages(pages, _sectionid){
	...
	//**** THIS ONE CALLED ****/
	//**  NEED TO GET THIS TO ONE FUNCTION***/
	...
	filter_populateMenu(pages){
		...
		for (var page of parentpages)  //looping around the parentpages
		{
			...
			_html_menu = _html_menu +	"<a onclick=\"menuItem_click(event," + page.pageid + "," + this.sectionid + ")\" href=''" + current_page + ">" + page.pagename + html_count_string + "</a>";
